...
export default function Sellling(){
    return (
        <main className="mt-20 oveflow-x-hidden ">
        ...
        <div>
            ...
            <section className="flex  mt-4  justify-between">
                <h2 className="font-semibold md:text-3xl">Best Selling Products</h2>  
                <Button className="px-12 py-4 md:py-7 bg-[#DB4444]">View All</Button>
            </section>
        ...
        <div className="bg-black  mt-32">
            <div className="md:flex justify-between py-4 px-4    md:py-[80px] max-w-[1000px]  md overflow-clip mx-auto">
            <section className="max-w-md space-y-12">
                <h1 className="text-[#00FF66] font-semibold">Categories</h1>
                <h2 className="text-white font-semibold texl-2xl md:text-5xl">Enhance Your Music Experience</h2>
            ...
            <section className="flex justify-center items-center my-4 md:my-0">
